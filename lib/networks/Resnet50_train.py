...
#        anchor_size = [None, None, 32, 64, 128, 256, 512] # P6 should be in RPN, but not Fast-RCNN, according to the paper
        ...
        (self.feed('data')
             .conv(7, 7, 64, 2, 2, relu=False, name='conv1',trainable=False)#
             .batch_normalization(relu=True, name='bn_conv1', is_training=False)
             .max_pool(3, 3, 2, 2, padding='VALID',name='pool1')
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2a_branch1',trainable=False)#
             .batch_normalization(name='bn2a_branch1',is_training=False,relu=False))

        (self.feed('pool1')
             .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2a_branch2a',trainable=False)#
             .batch_normalization(relu=True, name='bn2a_branch2a',is_training=False)
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2a_branch2b',trainable=False)#
             .batch_normalization(relu=True, name='bn2a_branch2b',is_training=False)
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2a_branch2c',trainable=False)#
        ...
        (self.feed('bn2a_branch1',
             ...
             .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2b_branch2a',trainable=False)#
             .batch_normalization(relu=True, name='bn2b_branch2a',is_training=False)
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2b_branch2b',trainable=False)#
             .batch_normalization(relu=True, name='bn2b_branch2b',is_training=False)
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2b_branch2c',trainable=False)#
        ...
        (self.feed('res2a_relu',
             ...
             .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2c_branch2a',trainable=False)#
             .batch_normalization(relu=True, name='bn2c_branch2a',is_training=False)
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2c_branch2b',trainable=False)#
             .batch_normalization(relu=True, name='bn2c_branch2b',is_training=False)
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2c_branch2c',trainable=False)#
...
# res3_5
        ...
        (self.feed('res4f_relu')
             .conv(3,3,512,1,1,name='rpn_conv/3x3')#3
             .conv(1,1,len(anchor_scales)*anchor_nratios*2 ,1 , 1, padding='VALID', relu = False, name='rpn_cls_score'))
        ...
        (self.feed('rpn_conv/3x3')#3
             .conv(1,1,len(anchor_scales)*anchor_nratios*4, 1, 1, padding='VALID', relu = False, name='rpn_bbox_pred'))
        ...
        (self.feed('rpn_cls_prob')#3
             .spatial_reshape_layer(len(anchor_scales)*anchor_nratios*2, name = 'rpn_cls_prob_reshape'))
...
#             .roi_pool(7,7,1.0/16,name='res5a_branch2a_roipooling')
        (self.feed('res3d_relu','roi-data')
             .roi_pool(7,7,1.0/8,name='res5a_branch2a_roipooling')

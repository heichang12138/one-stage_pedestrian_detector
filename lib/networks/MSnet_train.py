...
class MSnet_train(Network):
    ...
    def setup(self):
        ...
        (self.feed('rpn_cls_score/C5', 'rpn_cls_score/C6', 'gt_boxes', 'dontcare_areas', 'im_info')
             .multi_anchor_target_layer(_feat_stride, anchor_scales, name = 'rpn-data' ))             

        (self.feed('rpn_cls_prob_reshape/C5','rpn_cls_prob_reshape/C6',
                   'rpn_bbox_pred/C5', 'rpn_bbox_pred/C6','im_info')
             .multi_proposal_layer(_feat_stride, anchor_scales, 'TRAIN', name = 'rpn_rois'))